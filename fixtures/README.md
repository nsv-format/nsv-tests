...
Although this file was originally generated by the Python implementation
(`scripts/gen_champernowne.py`), it is not trusted from that single-impl
build: CI re-derives it from the raw Champernowne fixture in every
implementation and asserts byte equality (`scripts/coercion.sh`).
